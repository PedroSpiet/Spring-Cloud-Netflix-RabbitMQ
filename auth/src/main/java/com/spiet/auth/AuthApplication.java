package com.spiet.auth;

import com.spiet.auth.entity.Permission;
import com.spiet.auth.entity.User;
import com.spiet.auth.repositories.PermissionRepository;
...
public class AuthApplication {
    ...
    private void initUsers(UserRepository userRepository, PermissionRepository permissionRepository,
        ...
        User find = userRepository.findByUsername("jondoe");
        if (find == null) {
